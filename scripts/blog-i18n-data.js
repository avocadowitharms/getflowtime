    ...
    de: {
      ...
      articles: {
        ...
        "interrupting-autopilot-conscious-app-blocking": {
          ...
          summaryPoints: [
            "Flowtime sperrt dich nicht dauerhaft aus blockierten Apps aus.",
            "Du kannst die Blockierung jederzeit bewusst aufheben.",
            "Das Ziel ist das Unterbrechen automatischer Gewohnheiten, nicht der Kontrollverlust."
          ],
          bodyHtml: `
      ...
      articles: {
        ...
        "interrupting-autopilot-conscious-app-blocking": {
          ...
          toc: [
            ...
            "Le pouvoir d'une petite interruption",
            "Vous n'êtes jamais piégé",
            "La prise de conscience est plus utile que la restriction",
            "Cela aide pour bien plus que la procrastination",
            "Une autre façon de penser le blocage d'applications",
            "Continuer la lecture"
          ],
          summaryPoints: [
            "Flowtime ne vous verrouille jamais l'accès de façon permanente.",
            "Vous pouvez interrompre le blocage dès que vous le décidez consciemment.",
            "Le but est d'interrompre le comportement automatique, pas d'enlever votre contrôle."
          ],
          bodyHtml: `
