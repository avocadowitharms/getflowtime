(function () {
  ...
  var copy = {
    en: {
      ...
      "focus.description": "Flowtime supports four distinct focus tracking modes tailored for work, study, ADHD time awareness, hyperfocus check-ins, and intentional breaks.",
      ...
      "focus.flowmodoro.title": "What is Flowmodoro?",
      "focus.flowmodoro.text": "The Flowtime Technique: work until focus fades, then take a break based on how long you focused.",
      "focus.pomodoro.title": "How does Pomodoro work in Flowtime?",
      "focus.pomodoro.text": "Stay structured with configurable work and break intervals.",
      "focus.flow.title": "What is a Flow Session?",
      "focus.flow.text": "Set a target duration, receive gentle check-in reminders, and decide when to stop.",
      ...
      "waitlist.title": "Get news!",
      "waitlist.description": "Get app updates, release notes and future news.",
    ...
    de: {
      ...
      "focus.description": "Flowtime unterstützt vier verschiedene Fokusmodi für Arbeit, Lernen, ADHS-Zeitwahrnehmung, Hyperfokus-Check-ins und bewusste Pausen.",
      "focus.classic.title": "Klassischer Timer",
      "focus.classic.text": "Einfache, intuitive Zeiterfassung.",
      "focus.flowmodoro.title": "Was ist Flowmodoro?",
      "focus.flowmodoro.text": "Die Flowtime-Technik: Arbeite, bis der Fokus nachlässt, und mache dann eine Pause, deren Länge sich nach deiner Fokuszeit richtet.",
    ...
    fr: {
      ...
      "focus.description": "Flowtime propose quatre modes de concentration distincts pour le travail, les études, la perception du temps liée au TDAH, les rappels d’hyperfocus et les pauses intentionnelles.",
      "focus.classic.title": "Minuteur classique",
      "focus.classic.text": "Un suivi du temps simple et intuitif.",
      "focus.flowmodoro.title": "Qu’est-ce que Flowmodoro ?",
      "focus.flowmodoro.text": "La technique Flowtime : travaillez jusqu’à ce que la concentration diminue, puis prenez une pause adaptée à la durée de votre concentration.",
      "focus.pomodoro.title": "Pomodoro",
