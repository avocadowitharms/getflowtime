(function () {
  ...
  var copy = {
    en: {
      ...
      "hero.title": "A focus timer that works with your attention.",
      "hero.description": "Start when you need to focus. Get reminders when you've disappeared too deep. Block the apps that hijack your attention.",
      ...
      "reviews.eyebrow": "From the app stores",
      "reviews.title": "Loved by Flowtime users.",
      "reviews.listLabel": "Five-star reviews. Scroll horizontally for more.",
      "reviews.fiveStars": "5 out of 5 stars",
      "reviews.verified": "Five-star review",
      "reviews.more": "Swipe to read more reviews →",
      ...
      "focus.description": "Flowtime supports four distinct focus tracking modes tailored for work, study, time awareness, hyperfocus check-ins, and intentional breaks.",
      "focus.classic.title": "Classic Timer",
      "focus.classic.text": "Track time with a simple count-up timer.",
      "focus.flowmodoro.title": "Flowmodoro",
      "focus.flowmodoro.text": "Focus until you stop, then take a break based on session length.",
      ...
      "blocking.eyebrow": "Distraction control",
      "blocking.title": "Block distractions without giving up control.",
      ...
      "reports.title": "How do Flowtime reports help track focus?",
      "reports.description": "Flowtime provides visual time breakdown charts by project, timer mode, and custom time ranges.",
      "reports.today": "Today",
      ...
      "pricing.description": "Flowtime offers a comprehensive Free tier with essential timers and optional Pro upgrades for unlimited customization and analytics.",
      "pricing.free": "Free",
      "pricing.free.title": "What is included in Flowtime Free?",
      "pricing.free.timer": "Standard Timer",
      "pricing.free.notifications": "Standard notifications",
      "pricing.free.pomodoro": "Pomodoro (fixed intervals)",
      "pricing.free.projects": "1 Project",
      "pricing.free.history": "1 day of History",
      "pricing.pro.title": "What features are in Flowtime Pro?",
      "pricing.pro.flow_sessions": "Flow Sessions",
      "pricing.pro.flowmodoro": "Flowmodoro",
      "pricing.pro.pomodoro": "Custom Pomodoro intervals",
      "pricing.pro.projects": "Unlimited Projects",
      "pricing.pro.history": "Unlimited History",
      "pricing.pro.blocking": "App Blocking",
      "pricing.pro.templates": "Quick Start Templates",
      "pricing.pro.reminders": "Reminder Profiles",
      "pricing.pro.customization": "UI customization (accent colors)",
      "pricing.pro.reports": "Reports & Exports",
      "pricing.pro.future": "All future pro features",
      ...
      "faq.who.a": "Flowtime is for people who want to make focus time visible without managing a heavy workspace. It is especially suited to work, study, creative projects, and simple personal time tracking.",
      ...
      "modal.close": "Close",
      "footer.copyright": "&copy; 2026 gugus. Software&Things",
      "footer.links": "Legal and support",
      "footer.about": "About Flowtime",
      "footer.privacy": "Privacy Policy",
      "footer.terms": "Terms of Use",
      "footer.support": "Support",
      "footer.creator": "gugus. Software&Things",
    ...
    de: {
      ...
      "hero.title": "Ein Fokus-Timer, der mit deiner Aufmerksamkeit arbeitet.",
      ...
      "reviews.eyebrow": "Aus den App Stores",
      "reviews.title": "Von Flowtime-Nutzern geschätzt.",
      "reviews.listLabel": "Fünf-Sterne-Bewertungen. Horizontal scrollen für mehr.",
      "reviews.fiveStars": "5 von 5 Sternen",
      "reviews.verified": "Fünf-Sterne-Bewertung",
      "reviews.more": "Wischen für weitere Bewertungen →",
      "launch.eyebrow": "Launch-Ankündigung",
      "launch.title": "Jetzt im App Store und bei Google Play verfügbar",
      ...
      "focus.title": "Vier Arten zu fokussieren.",
      "focus.description": "Flowtime unterstützt vier verschiedene Fokusmodi für Arbeit, Lernen, Zeitwahrnehmung, Hyperfokus-Check-ins und bewusste Pausen.",
      "focus.classic.title": "Klassischer Timer",
      "focus.classic.text": "Einfache, intuitive Zeiterfassung.",
      "focus.flowmodoro.title": "Flowmodoro",
      "focus.flowmodoro.text": "Fokussiere bis zum Stopp und pausiere passend zur Session-Länge.",
      "focus.pomodoro.title": "Pomodoro",
      ...
      "blocking.eyebrow": "Ablenkungskontrolle",
      "blocking.title": "Blockiere Ablenkungen, ohne die Kontrolle abzugeben.",
      "blocking.description": "Flowtime hilft, Ablenkungen zu reduzieren, indem ausgewählte Apps während einer Fokus-Session vorübergehend blockiert werden. Statt dich nur auf Willenskraft zu verlassen, legst du im Voraus fest, welche Apps während der Arbeit nicht verfügbar sein sollen.",
      "blocking.override": "Wenn du eine blockierte App wirklich brauchst, kannst du die Blockierung jederzeit bewusst aufheben. So entsteht ein kurzer Moment der Aufmerksamkeit, bevor du die Aufgabe wechselst. Dieser Ansatz reduziert impulsive Ablenkungen und lässt dir trotzdem die Kontrolle.",
      "blocking.article.title": "Den Autopiloten unterbrechen: Bewusste Entscheidungen beim Blockieren von Apps",
      "blocking.article.href": "de/guides/autopilot-unterbrechen-apps-bewusst-blockieren/index.html",
      "project.work": "Arbeit",
      ...
      "pricing.free.timer": "Standard-Timer",
      "pricing.free.notifications": "Standardbenachrichtigungen",
      "pricing.free.pomodoro": "Pomodoro (feste Intervalle)",
      "pricing.free.projects": "1 Projekt",
      "pricing.free.history": "1 Tag Verlauf",
      "pricing.pro.title": "Mehr Kontrolle,<br />ohne mehr Unruhe.",
      "pricing.pro.flow_sessions": "Flow Sessions",
      "pricing.pro.flowmodoro": "Flowmodoro",
      "pricing.pro.pomodoro": "Eigene Pomodoro-Intervalle",
      "pricing.pro.projects": "Unbegrenzte Projekte",
      "pricing.pro.history": "Unbegrenzter Verlauf",
      "pricing.pro.blocking": "App-Blocking",
      "pricing.pro.templates": "Quick-Start-Vorlagen",
      "pricing.pro.reminders": "Erinnerungsprofile",
      "pricing.pro.customization": "UI-Anpassung (Akzentfarben)",
      "pricing.pro.reports": "Berichte & Exporte",
      "pricing.pro.future": "Alle zukünftigen Pro-Funktionen",
      "social.eyebrow": "Social",
      ...
      "faq.what.a": "Flowtime kombiniert flexible Fokus-Sessions, Pomodoro, Erinnerungen, Zeiterfassung und optionales App-Blocking. Es hilft dir zu erkennen, wohin deine Zeit geht, bei tiefem Fokus aufmerksam zu bleiben und bewusst aufzuhören—ohne Account.",
      "faq.who.q": "Für wen ist Flowtime gedacht?",
      "faq.who.a": "Flowtime ist für Menschen gedacht, die Fokuszeit sichtbar machen möchten, ohne einen schweren Workspace zu verwalten. Es eignet sich besonders für Arbeit, Studium, kreative Projekte und einfache persönliche Zeiterfassung.",
      ...
      "faq.languages.a": "Flowtime unterstützt aktuell 10 Sprachen: Englisch, Deutsch, Spanisch, Französisch, Italienisch, Japanisch, Koreanisch, Niederländisch, Polnisch und Portugiesisch.",
    ...
    fr: {
      ...
      "hero.title": "Un minuteur qui s'adapte à votre attention.",
      ...
      "reviews.eyebrow": "Avis des App Stores",
      "reviews.title": "Apprécié par les utilisateurs de Flowtime.",
      "reviews.listLabel": "Avis cinq étoiles. Faites défiler horizontalement pour en voir plus.",
      "reviews.fiveStars": "5 étoiles sur 5",
      "reviews.verified": "Avis cinq étoiles",
      "reviews.more": "Balayez pour lire plus d’avis →",
      ...
      "focus.title": "Quatre façons de se concentrer.",
      "focus.description": "Flowtime propose quatre modes de concentration distincts pour le travail, les études, la perception du temps, les rappels d’hyperfocus et les pauses intentionnelles.",
      "focus.classic.title": "Minuteur classique",
      "focus.classic.text": "Un suivi du temps simple et intuitif.",
      "focus.flowmodoro.title": "Flowmodoro",
      "focus.flowmodoro.text": "Concentrez-vous jusqu’à l’arrêt, puis adaptez la pause à la durée de la session.",
      "focus.pomodoro.title": "Pomodoro",
      ...
      "blocking.eyebrow": "Contrôle des distractions",
      "blocking.title": "Bloquez les distractions sans perdre le contrôle.",
      "blocking.description": "Flowtime aide à réduire les distractions en bloquant temporairement les apps sélectionnées pendant une session de concentration. Au lieu de compter uniquement sur votre volonté, vous décidez à l’avance quelles apps doivent rester indisponibles pendant votre travail.",
      "blocking.override": "Si vous avez réellement besoin d’accéder à une app bloquée, vous pouvez toujours choisir de lever le blocage intentionnellement. Ce petit moment de réflexion avant de changer de tâche aide à réduire les distractions impulsives tout en vous laissant le contrôle.",
      "blocking.article.title": "Interrompre le pilote automatique : décider consciemment face au blocage des applications",
      "blocking.article.href": "fr/guides/interrompre-pilote-automatique-blocage-applications/index.html",
      ...
      "pricing.free.timer": "Minuteur standard",
      "pricing.free.notifications": "Notifications standard",
      "pricing.free.pomodoro": "Pomodoro (intervalles fixes)",
      "pricing.free.projects": "1 projet",
      "pricing.free.history": "1 jour d'historique",
      "pricing.pro.title": "Plus de contrôle,<br />sans complexité.",
      "pricing.pro.flow_sessions": "Flow Sessions",
      "pricing.pro.flowmodoro": "Flowmodoro",
      "pricing.pro.pomodoro": "Intervalles Pomodoro personnalisés",
      "pricing.pro.projects": "Projets illimités",
      "pricing.pro.history": "Historique illimité",
      "pricing.pro.blocking": "Blocage d'apps",
      "pricing.pro.templates": "Modèles Quick Start",
      "pricing.pro.reminders": "Profils de rappel",
      "pricing.pro.customization": "Personnalisation de l'interface (couleurs d'accent)",
      "pricing.pro.reports": "Rapports et exports",
      "pricing.pro.future": "Toutes les futures fonctionnalités Pro",
      "social.eyebrow": "Social",
      ...
      "faq.what.a": "Flowtime combine des sessions de concentration flexibles, Pomodoro, des rappels, le suivi du temps et le blocage d'apps optionnel. Il vous aide à voir où passe votre temps, à rester attentif pendant une concentration profonde et à vous arrêter intentionnellement—sans compte.",
      "faq.who.q": "À qui s'adresse Flowtime ?",
      "faq.who.a": "Flowtime s'adresse aux personnes qui veulent rendre leur temps de concentration visible sans gérer un espace de travail lourd. Il convient particulièrement au travail, aux études, aux projets créatifs et au suivi personnel simple du temps.",
  ...
  var staticPageTranslations = {
    en: {
      "positioning.eyebrow": "Does this feel familiar?",
      "positioning.title": "Time can disappear while you work.",
      "positioning.description": "Flowtime is built for the everyday moments when attention drifts, stretches, or gets pulled elsewhere.",
      "positioning.time.title": "Time blindness",
      "positioning.time.text": "You start one task and suddenly hours have passed. A visible session timer and focus reminders make passing time easier to notice.",
      "positioning.hyperfocus.title": "Hyperfocus",
      "positioning.hyperfocus.text": "Getting focused is not always the problem. Sometimes stopping is. Flow Sessions create flexible boundaries without pulling you out at the wrong moment.",
      "positioning.hijacking.title": "Attention hijacking",
      "positioning.hijacking.text": "One notification becomes twenty minutes of scrolling. App blocking protects intentional focus time and reduces context switching.",
      ...
      "founder.p1": "Ava, the founder of Flowtime, has ADHD. During intense hyperfocus, she can spend weeks mentally stuck on work, features, UI details, or whatever her brain has decided matters. Even when she stops working physically, her brain often keeps going. That experience influenced Flowtime, a flexible focus timer and time tracker for anyone.",
      "founder.p2": "Flowtime began as a way to focus longer. Over time, it also became a way to unfocus on purpose. Sometimes Ava starts a one-hour FlowSession, blocks distracting apps, and goes for a walk with her dog. Knowing the timer is running and the usual apps are unavailable makes it easier for her to be present instead of repeatedly checking her phone or thinking about work.",
      "product.eyebrow": "Product facts",
      "product.title": "What is Flowtime?",
      "product.description": "Flowtime combines flexible focus sessions, Pomodoro, reminders, time tracking, and optional app blocking. It helps you notice where your time goes, stay aware during deep focus, and stop intentionally—without requiring an account.",
    ...
    de: {
      ...
      "founder.title": "Warum wurde Flowtime entwickelt?",
      "founder.p1": "Ava, die Gr\u00fcnderin von Flowtime, hat ADHS. W\u00e4hrend intensiver Hyperfokus-Phasen kann sie wochenlang gedanklich an Arbeit, Features, UI-Details oder dem h\u00e4ngen, was ihr Gehirn gerade wichtig findet. Selbst wenn sie k\u00f6rperlich aufh\u00f6rt zu arbeiten, macht ihr Kopf oft weiter. Diese Erfahrung hat Flowtime geprägt, einen flexiblen Fokus-Timer und persönlichen Time Tracker für alle.",
      "founder.p2": "Flowtime begann als M\u00f6glichkeit, l\u00e4nger zu fokussieren. Mit der Zeit wurde es auch eine M\u00f6glichkeit, absichtlich zu ent-fokussieren. Manchmal startet Ava eine einst\u00fcndige FlowSession, blockiert ablenkende Apps und geht mit ihrem Hund spazieren. Zu wissen, dass der Timer l\u00e4uft und die \u00fcblichen Apps nicht verf\u00fcgbar sind, macht es ihr leichter, pr\u00e4sent zu sein, statt st\u00e4ndig aufs Handy zu schauen oder an Arbeit zu denken.",
      "product.eyebrow": "Produkt-Fakten",
      "product.title": "Was ist Flowtime?",
      "product.description": "Flowtime kombiniert flexible Fokus-Sessions, Pomodoro, Erinnerungen, Zeiterfassung und optionales App-Blocking. Es hilft dir zu erkennen, wohin deine Zeit geht, bei tiefem Fokus aufmerksam zu bleiben und bewusst aufzuhören—ohne Account.",
    ...
    fr: {
      ...
      "founder.title": "Pourquoi Flowtime a-t-il \u00e9t\u00e9 cr\u00e9\u00e9 ?",
      "founder.p1": "Ava, la fondatrice de Flowtime, a un TDAH. Pendant les phases d'hyperfocus intense, elle peut rester mentalement bloqu\u00e9e pendant des semaines sur le travail, les fonctionnalit\u00e9s, les d\u00e9tails d'interface ou ce que son cerveau a d\u00e9cid\u00e9 de trouver important. M\u00eame quand elle arr\u00eate physiquement de travailler, son cerveau continue souvent. Cette expérience a influencé Flowtime, un minuteur de concentration flexible et un outil de suivi du temps pour tout le monde.",
      "founder.p2": "Flowtime a commenc\u00e9 comme une fa\u00e7on de se concentrer plus longtemps. Avec le temps, c'est aussi devenu une fa\u00e7on de d\u00e9crocher volontairement. Parfois, Ava lance une FlowSession d'une heure, bloque les apps distrayantes et va promener son chien. Savoir que le minuteur tourne et que les apps habituelles sont indisponibles l'aide \u00e0 \u00eatre pr\u00e9sente au lieu de v\u00e9rifier son t\u00e9l\u00e9phone ou de penser au travail.",
      "product.eyebrow": "Infos produit",
      "product.title": "Qu'est-ce que Flowtime ?",
      "product.description": "Flowtime combine des sessions de concentration flexibles, Pomodoro, des rappels, le suivi du temps et le blocage d'apps optionnel. Il vous aide à voir où passe votre temps, à rester attentif pendant une concentration profonde et à vous arrêter intentionnellement—sans compte.",
      ...
      graph.forEach(function (node) {
        ...
        if (node["@type"] === "FAQPage" && Array.isArray(node.mainEntity)) {
          [
            ...
            ["faq.free.q", "faq.free.a"],
            ["faq.platform.q", "faq.platform.a"],
            ["faq.languages.q", "faq.languages.a"],
            ["faq.flow.q", "faq.flow.a"],
            ["faq.pomodoro.q", "faq.pomodoro.a"],
            ["faq.privacy.q", "faq.privacy.a"],
            ["faq.pro.q", "faq.pro.a"],
            ["faq.beta.q", "faq.beta.a"]
