(function () {
  ...
  var copy = {
    en: {
      ...
      "faq.free.a": "Yes. Free includes the standard timer, Flow Session, Pomodoro, 2 projects, and 2 Quick Start templates. Pro is available for $3.99/month, $24.99/year, or $49.99 lifetime to unlock unlimited projects, templates, custom reminders, advanced Pomodoro, and analytics.",
  ...
  var staticPageTranslations = {
    en: {
      ...
      "founder.p1": "I built Flowtime because most productivity tools added more friction than they removed. I wanted a timer that made it easy to begin, kept time visible, and helped me step away when I had done enough.",
    ...
    de: {
      ...
      "founder.p1": "Ich habe Flowtime gebaut, weil die meisten Produktivit\u00e4ts-Tools mehr Reibung erzeugt als entfernt haben. Ich wollte einen Timer, mit dem ich leicht anfangen, die Zeit im Blick behalten und rechtzeitig aufh\u00f6ren kann.",
