(function () {
  ...
  var copy = {
    en: {
      "meta.title": "Flowtime - ADHD Focus Timer, Hyperfocus Timer, and Pomodoro Alternative",
      "meta.description": "Flowtime is a flexible ADHD focus timer, hyperfocus timer, time tracker, app blocker, and Pomodoro alternative for work, study, and deep focus.",
      ...
      "faq.what.a": "Flowtime is a flexible ADHD focus timer, hyperfocus timer, time tracker, and app blocker for iPhone and Android. It supports a standard timer, Flow Sessions, Pomodoro, projects, reminders, history, reports, and privacy-first personal productivity.",
      "faq.who.q": "Who is Flowtime for?",
      "faq.who.a": "Flowtime is for people who want to make focused time visible without managing a heavy workspace. It can be especially useful for ADHD time awareness and hyperfocus check-ins, and it still fits students, freelancers, developers, writers, researchers, and anyone who prefers simple personal time tracking.",
      ...
      "download.description": "Use a calm ADHD focus timer, hyperfocus timer, time tracker, app blocker, and Pomodoro alternative for work, study, deep focus, and intentional breaks.",
      "modal.close": "Close",
  ...
  var staticPageTranslations = {
    en: {
      ...
      "positioning.time.text": "You start one task and suddenly hours have passed. A visible ADHD timer and gentle reminders make passing time easier to notice.",
